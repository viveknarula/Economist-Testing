...
import com.economists.generalutils.*;
import com.economists.seleniumutils.Screenshot;
...
public class Hooks {
	...
	public void beforestartUp(Scenario scenario) throws IOException {
		...
		// variables
				// jenkinsAppURL,jenkinsSeleniumServerURL,jenkinsRunMode,jenkinsExecutionId
				// are used for holding value from Jenkins if not provided the value set
				// in the config.json is used.

				String jenkinsAppURL = System.getProperty("ApplicationURL");
				String jenkinsSeleniumServerURL = System.getProperty("SeleniumServerURL");
				String jenkinsRunMode = System.getProperty("RunMode");
				String jenkinsExecutionId = System.getProperty("ExecutionID");
